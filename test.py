...
async def upload_file(request: Request,file: UploadFile = File(...),file1: UploadFile = File(...)):
    ...
    openai = AzureOpenAI(
    api_version='2024-02-01',azure_endpoint="https://openai-wu-genai-mmp-d.openai.azure.com/",azure_deployment='gpt-4o',api_key=os.getenv('open_ai'))
    ...
    openai = AzureOpenAI(
    api_version='2024-02-01',azure_endpoint="https://openai-wu-genai-mmp-d.openai.azure.com/",azure_deployment='o1-mini',api_key=os.getenv('open_ai'))
